...
class Countries(CoreModel):
    ...
    code_alfa_2 = models.CharField(max_length=2,
                                   unique=True,
                                   blank=False,
                                   )
...
class Companies(CoreModel):
    ...
    krs = models.PositiveIntegerField(verbose_name='KRS number',
                              unique=True,
                              )
    regon = models.PositiveIntegerField(verbose_name='Regon number',
                                unique=True,
                                )
    nip = models.PositiveIntegerField(verbose_name='Nip code',
                              unique=True,
                              )
    capital_group_name = models.ForeignKey(CompaniesGroup,
