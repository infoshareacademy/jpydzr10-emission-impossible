...
for y in years:
    custom_factors.append(("Energia elektryczna z OZE", y, 0.815, "tCO2e/MWh"))

# Energia elektryczna nie OZE
for y in years:
    custom_factors.append(("Energia elektryczna nie OZE", y, 0.815, "tCO2e/MWh"))

# Ciepło z OZE
for y in years:
    custom_factors.append(("Ciepło z OZE", y, 0.32, "tCO2e/GJ"))

# Ciepło nie OZE
for y in years:
    custom_factors.append(("Ciepło nie OZE", y, 0.32, "tCO2e/GJ"))

# Chłód z OZE
for y in years:
    custom_factors.append(("Chłód z OZE", y, 0.32, "tCO2e/GJ"))

# Chłód nie OZE
for y in years:
    custom_factors.append(("Chłód nie OZE", y, 0.32, "tCO2e/GJ"))

# Para Techniczna z OZE
for y in years:
    custom_factors.append(("Para Techniczna z OZE", y, 0.32, "tCO2e/GJ"))

# Para Techniczna nie OZE
for y in years:
    custom_factors.append(("Para Techniczna nie OZE", y, 0.32, "tCO2e/GJ"))
...
for factor_name, year, factor, unit_factor in custom_factors:
    EmissionFactor.objects.get_or_create(
        ...
        year=year,
        country=poland,
        defaults={"factor": factor, "unit_factor": unit_factor, "source": "Custom"},
    )
