...
from emissions.models import StationaryCombustion, EnergyPurchased, EmissionFactor
from calculator.models import FuelType, FuelSpec
...
class CalculationEngineTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        fuel_coal = FuelType.objects.create(name="Węgiel kamienny", symbol="WEG", category="solid")
    ...
    def test_missing_fuel_spec_raises_validation_error(self):
        ...
        EmissionFactor.objects.create(
            factor_name="Drewno opałowe", year=2024, factor=Decimal("100"), unit_factor="kgCO2e/GJ"
        )
        ...
        with self.assertRaisesMessage(ValidationError, "Brak wartości opałowej"):
            calculate_record_emissions(record)
    ...
    def test_energy_purchased_custom_factor_priority(self):
        ...
        self.assertEqual(record.calculated_emission_tco2eq, Decimal("55.000"))
